 ...
 * 
 */
package com.wordfinder.exceptionhandler;
...
import com.wordfinder.responsebean.ErrorResponse;
...
public class GlobalExceptionHandler {
	 ...
	 * Exception handler.
	 *
	 * @param wordFinderBusinessException the word finder business exception
	 * @return the response entity
	 */
	@ExceptionHandler(WordFinderBusinessException.class)
	public ResponseEntity<RootResponse<ErrorResponse>> exceptionHandler(
			WordFinderBusinessException wordFinderBusinessException) {
		ErrorResponse error = new ErrorResponse();
		error.setErrorCode(HttpStatus.PRECONDITION_FAILED.value());
		error.setMessage(wordFinderBusinessException.getMessage());
	 ...
	 *
	 * @param noHandlerFoundException the no handler found exception
	 * @return the response entity
	 */
	@Loggable
	 ...
	 *
	 * @param wordFinderApplicationException the word finder application exception
	 * @return the response entity
	 */
	@Loggable
	@ExceptionHandler(value = { WordFinderApplicationException.class })
	public ResponseEntity<ErrorResponse> applicationExceptionHandler(
			WordFinderApplicationException wordFinderApplicationException) {
		logger.error("Error while processing :", wordFinderApplicationException);
		ErrorResponse error = new ErrorResponse();
		error.setErrorCode(HttpStatus.INTERNAL_SERVER_ERROR.value());
		error.setMessage(wordFinderApplicationException.getMessage());
